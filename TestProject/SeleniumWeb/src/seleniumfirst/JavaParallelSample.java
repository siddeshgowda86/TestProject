...
class ParallelTest implements Runnable {
  public static final String USERNAME = "siddeshgowda_GPt4ih";
	public static final String AUTOMATE_KEY = "rRwyDMpsvUyeJx6T8QEy";
  ...
  public void run() {
    DesiredCapabilities caps = new DesiredCapabilities();
		...
		caps.setCapability("buildName", "BStack-[Java] Sample build"); // CI/CD job or build name
		WebDriver driver;
		try {
